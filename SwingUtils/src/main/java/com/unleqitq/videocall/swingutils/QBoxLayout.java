...
public class QBoxLayout implements LayoutManager2, Serializable {
    ...
    public QBoxLayout(Container target, int axis, int maxOtherSize) {
        ...
        this.axis = axis;
        this.target = target;
        this.maxOtherSize = maxOtherSize;
    }
     ...
     *   null if none
     */
    QBoxLayout(Container target, int axis, int maxOtherSize, PrintStream dbg) {
        this(target, axis, maxOtherSize);
        this.dbg = dbg;
    }
